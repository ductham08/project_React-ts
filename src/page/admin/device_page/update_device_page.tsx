      ...
      <div className="title_page">
        <div className="nav_number_page">
          <div className="url_nav">
            ...
            <p className="url_2">
              <Link to="">Cập nhật thiết bị</Link>
            </p>
          </div>
          ...
          <div className="form_data">
            ...
            <div className="form">
              ...
              <div className="item_form">
                ...
                <div className="select_box">
                  <select>
                    ...
                    <option
                      {...() => (device?.device_type == 1 ? `selected` : "")}
                      value="1"
                    >
                      Kios
                    </option>
                    <option
                      {...() => (device?.device_type == 2 ? `selected` : "")}
                      value="2"
                    >
                      Display counter
                    </option>
              ...
              <div className="item">
                ...
                <input
                  type="text"
                  value={device?.device_service?.map((item: any) => item)}
