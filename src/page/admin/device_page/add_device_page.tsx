...
import "../../../public/css/admin/add_device_page.css"

type Props = {}

const Add_device_page = (props: Props) => {
    return (
        <div className='add_device_page'>
            ...
            <div className="title_page">
                <div className="nav_number_page">
                    <div className="url_nav">
                        ...
                        <p className='url_2'><Link to="">Thêm thiết bị</Link></p>
                    </div>
            ...
            <div className="main_page">
                ...
                <div className="list_button">
                    ...
                    <button className='next'>Thêm thiết bị</button>
                </div>
            </div>
        </div>
    )
...
export default Add_device_page