...
import "../../../public/css/admin/device_page.css";
...
const Device_layout = (props: Props) => {
  ...
  const status = (value: any) => {
    ...
    return "<><button className='remove_status'></button>Ngưng hoạt động</>";
  };
                  ...
                  Devices.map((device) => {
                    return (
                      <tr>
                        ...
                        <td>
                          <div className="status">
                            {device?.active_status == 1 ? (
                              <button className="active_status"></button>
                            ) : (
                        ...
                        <td>
                          <Link to={`${device?.id}`}>Chi tiết</Link>
                        </td>
                        <td>
                          <Link to={`update/${device?.id}`}>Cập nhật</Link>
                        </td>
                      </tr>
                    );
                  })}
